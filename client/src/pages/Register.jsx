...
//       await axios.post("https://resource-allocator-project.onrender.com/api/auth/register", data, {
...
import axios from "axios";
import { useNavigate, Link } from "react-router-dom";
import "../pages/register.css"; // Dark UI CSS
  ...
  return (
    <div className="register-page-wrapper">
      ...
      <div className="register-box">
        ...
        <p className="subtitle">Join DBATU Scholar Hub</p>
